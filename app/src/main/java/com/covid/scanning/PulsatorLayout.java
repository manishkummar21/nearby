...
public class PulsatorLayout extends RelativeLayout {
    ...
    private HashMap<String, DiscoveredEndpointInfo> bluetoothDeviceHashMap;
    ...
    public void addImageview(float x, float y, DiscoveredEndpointInfo device, boolean isDetecteddevice) {
    ...
    public void addDetecteddevice(DiscoveredEndpointInfo device) {


        if (device != null && !TextUtils.isEmpty(device.getEndpointName()) && !bluetoothDeviceHashMap.containsKey(device.getEndpointName())) {
            bluetoothDeviceHashMap.put(device.getEndpointName(), device);
